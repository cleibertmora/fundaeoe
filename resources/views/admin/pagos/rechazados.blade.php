...
@section('content')
<div class="container">
    <h1 class=page-header id=glyphicons>Lista de Pagos Rechazados</h1>
                ...
                @foreach($pagos as $pago)
                    <tr>
                        ...
                        <td style="vertical-align:middle">
                            <a href="{{ route('pagos.porverificar', $pago->id) }}" class="btn btn-warning">
                                <span class="glyphicon glyphicon-refresh" style="font-size:18px; vertical-align: middle;" aria-hidden="true"></span>
                            </a>
                        </td>
                    </tr>
                @endforeach
