...
@section('title','Eventos - Jornadas')
@section('content')
<section id="blog">
   <div class="container">
        <div class="section-header">
            <h2 class="section-title text-center wow fadeInDown">Nuestras Jornadas</h2>
            <p class="text-center wow fadeInDown">Periodos de capacitaciones más cortas.</p>
        </div>
