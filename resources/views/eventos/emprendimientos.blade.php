...
@section('title','Eventos - Emprendimientos')
@section('content')
<section id="blog">
   <div class="container">
        <div class="section-header">
            <h2 class="section-title text-center wow fadeInDown">Nuestros Emprendimientos</h2>
            <p class="text-center wow fadeInDown">Evolución de la nueva era, Comercio, Dinero, Internet, Personas, Proyección Motora de la realidad de la economía Mundial. Personas que se quieran Diversificar.</p>
        </div>
