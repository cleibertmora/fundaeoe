...
@section('title','Eventos - Cursos')
@section('content')
<section id="blog">
   <div class="container">
        <div class="section-header">
            <h2 class="section-title text-center wow fadeInDown">Nuestros Cursos</h2>
            <p class="text-center wow fadeInDown">El curso forma parte de la educación formal ya que está sistematizado en torno a un tema, a una proyección temporaria, al material que se utilizará, a las estrategias prácticas pensadas para cada temática, a un saber pre-existente también formalizado.</p>
        </div>
