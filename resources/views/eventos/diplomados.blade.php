...
@section('title','Eventos - Diplomados')
@section('content')
<section id="blog">
   <div class="container">
        <div class="section-header">
            <h2 class="section-title text-center wow fadeInDown">Nuestros Diplomados</h2>
            <p class="text-center wow fadeInDown">Programa organizado en módulos que agrupan contenidos de una o varias disciplinas, complementando otras áreas en la actividad profesional. Tiene una duración aproximada de entre 100-120 horas.</p>
        </div>
